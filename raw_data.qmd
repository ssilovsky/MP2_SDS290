...
df$var2[df$treatment == "nogi_friends_normal"] <- 2
...
ggplot(data = df, mapping = aes(x=group, y =sit_and_eat,  fill = group)) +
geom_col()+
...
ggplot(data = df, mapping = aes(x=group, y =find_new_dining,  fill = group)) +
geom_col()+
  labs(title = "Group Agreement to Find new Dining Hall",
       y = "Total Level of Agreement(1:Strongly Disagree, 7:Strongly Agree)", fill = "Treatment Group",
       x = "Treatment Group")

ggplot(data = df, mapping = aes(x=group, y =enjoy_eating,  fill = group)) +
geom_col()+
...
qplot(x=group, y=sit_and_eat, data=df, ylab="Agreement Level", geom="boxplot") +theme(axis.title = element_text(size = 15))
qplot(x=group, y=find_new_dining, data=df, ylab="Agreement Level", geom="boxplot") +theme(axis.title = element_text(size = 15))
qplot(x=group, y=grab_and_go, data=df, ylab="Agreement Level", geom="boxplot") +theme(axis.title = element_text(size = 15))
qplot(x=group, y=enjoy_eating, data=df, ylab="Agreement Level", geom="boxplot") +theme(axis.title = element_text(size = 15))
```
